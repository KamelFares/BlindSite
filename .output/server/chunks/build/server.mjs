import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { computed, hasInjectionContext, getCurrentInstance, defineComponent, shallowRef, h, resolveComponent, toRef, isRef, inject, createElementBlock, provide, cloneVNode, ref, Suspense, Fragment, useSSRContext, createApp, createVNode, Text, shallowReactive, watch, mergeProps, unref, withCtx, createTextVNode, toDisplayString as toDisplayString$1, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, defineAsyncComponent, getCurrentScope, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { m as getContext, n as sanitizeStatusCode, $ as $fetch, o as createHooks, i as createError$1, p as getRequestProtocol, q as getRequestHeaders, r as executeAsync, v as defu, w as klona, x as parse$1, y as getRequestHeader, d as destr, z as isEqual$1, A as setCookie, B as getCookie, C as deleteCookie } from '../_/nitro.mjs';
import { b as baseURL } from '../routes/renderer.mjs';
import { RouterView, useRoute as useRoute$1, useRouter as useRouter$1, isNavigationFailure, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import { ssrRenderAttrs, ssrRenderList, ssrInterpolate, ssrRenderComponent, ssrRenderStyle, ssrRenderAttr, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
const _routes = [
  {
    name: "game___en",
    path: "/game",
    component: () => import('./game-ZeOfbSHX.mjs')
  },
  {
    name: "game___de",
    path: "/de/game",
  ...
  },
  {
    name: "index___en",
    path: "/",
    component: () => import('./index-Zlgal6QW.mjs')
  },
  {
    name: "index___de",
    path: "/de",
  ...
  },
  {
    name: "stick___en",
    path: "/stick",
    component: () => import('./stick-BIOUk1vF.mjs')
  },
  {
    name: "stick___de",
    path: "/de/stick",
  ...
  },
  {
    name: "colors___en",
    path: "/colors",
    component: () => import('./colors-CO7fGzsH.mjs')
  },
  {
    name: "colors___de",
    path: "/de/colors",
  ...
  },
  {
    name: "tunnel___en",
    path: "/tunnel",
    component: () => import('./tunnel-DsFKu_tL.mjs')
  },
  {
    name: "tunnel___de",
    path: "/de/tunnel",
  ...
  },
  {
    name: "macular___en",
    path: "/macular",
    component: () => import('./macular-ggjofdGA.mjs')
  },
  {
    name: "macular___de",
    path: "/de/macular",
  ...
  },
  {
    name: "cataract___en",
    path: "/cataract",
    component: () => import('./cataract-CAfMKQCX.mjs')
  },
  {
    name: "cataract___de",
    path: "/de/cataract",
  ...
  },
  {
    name: "migraine___en",
    path: "/migraine",
    component: () => import('./migraine-DU514ugK.mjs')
  },
  {
    name: "migraine___de",
    path: "/de/migraine",
  ...
  {
    name: "retinopathy___en",
    path: "/retinopathy",
    component: () => import('./retinopathy-CuxJ2sCb.mjs')
  },
  {
    name: "retinopathy___de",
    path: "/de/retinopathy",
    component: () => import('./retinopathy-CuxJ2sCb.mjs')
  },
  {
    name: "visual-snow___en",
    path: "/visual-snow",
    component: () => import('./visual-snow-nQYKBVau.mjs')
  },
  {
    name: "visual-snow___de",
    path: "/de/visual-snow",
    component: () => import('./visual-snow-nQYKBVau.mjs')
  }
];
...
const resource$1 = {
  "nav": {
    "light": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Light cone mode" } },
    "cane": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Cane simulation" } },
    "blindTouch": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Blind Touch game" } },
    "colorVision": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Color vision game" } },
    "cataract": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Cataract (blur + glare)" } },
    "macular": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Macular (central blind spot)" } },
    "visualSnow": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Visual Snow (neurological)" } },
    "retinopathy": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Retinopathy (floaters + patches)" } },
    "tunnel": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Tunnel vision" } },
    "migraine": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Migraine aura" } },
    "toggleLightOn": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Enable light effect" } },
    "toggleLightOff": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Disable light effect" } },
    "skip": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Skip to main content" } },
    "language": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Language" } }
  },
  "home": {
    "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "BlindSite" } },
    "subtitle1": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Scroll to explore. The screen is almost black — move your mouse to find hidden text." } },
    "subtitle2": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Left click creates an echo. Right click flashes. Hold right click to keep the flash on." } },
    "donateTitle": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Support blindness & disability organizations (Germany)" } },
    "donateNote": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "These links are provided for awareness and support. Please check the organization details before donating." } },
    "donateCta": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Open donation page" } },
    "donations": {
      "dbsv": {
        "name": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "DBSV – Deutscher Blinden- und Sehbehindertenverband" } },
        "desc": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "National association for blind and visually impaired people." } },
        "url": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "https://www.dbsv.org/" } }
      },
      "proretina": {
        "name": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "PRO RETINA Deutschland e. V." } },
        "desc": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Support and information around retinal diseases." } },
        "url": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "https://www.pro-retina.de/" } }
      },
      "aktionMensch": {
        "name": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Aktion Mensch" } },
        "desc": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Supports inclusion projects for people with disabilities." } },
        "url": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "https://www.aktion-mensch.de/" } }
      },
      "cbm": {
        "name": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "CBM Deutschland" } },
        "desc": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "International development organization focused on disability and eye health." } },
        "url": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "https://www.cbm.de/" } }
      }
    },
    "sections": {
      "what": {
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "What is blindness?" } },
        "text": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Blindness does not always mean seeing nothing at all. Many blind and low-vision people can see light, shapes, or limited detail." } }
      },
      "different": {
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Everyone’s vision loss is different" } },
        "text": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "There is no single “blind experience”. Some conditions affect the center, others the edges, contrast, or color perception. This site is an empathy demo, not a medical tool." } }
      },
      "navigate": {
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "How do blind people navigate?" } },
        "text": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Many people use a white cane or guide dog together with memory, sound, touch, and spatial awareness. Indoors, texture changes, echoes, and landmarks help build a mental map." } }
      },
      "tech": {
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Assistive technology" } },
        "text": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Screen readers (VoiceOver, NVDA, JAWS, TalkBack) read out interfaces. Keyboard shortcuts and gestures help users move by headings, links, and controls instead of using a mouse." } }
      },
      "design": {
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Good accessibility helps everyone" } },
        "text": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Clear headings, descriptive link text, form labels, and keyboard support remove barriers. Accessibility problems usually come from design choices, not from blindness itself." } }
      },
      "cataract": {
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Cataract (blur + glare) simulation" } },
        "text": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Cataracts can make vision cloudy with strong glare around lights. Try the mini-game and increase severity to feel how reading becomes harder." } },
        "cta": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Open simulation" } }
      },
      "macular": {
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Macular degeneration simulation" } },
        "text": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Central vision may be blocked or blurred while peripheral vision remains. Try the peripheral-shape game and change the spot size." } },
        "cta": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Open simulation" } }
      },
      "color": {
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Color vision game" } },
        "text": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Color-vision differences can make some shades hard to distinguish. Try finding the different circle and see why “color only” design can fail." } },
        "cta": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Open game" } }
      }
    }
  }
};
const resource = {
  "nav": {
    "light": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Lichtkegel-Modus" } },
    "cane": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Stock-Simulation" } },
    "blindTouch": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Blind-Touch-Spiel" } },
    "colorVision": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Farbsehen-Spiel" } },
    "cataract": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Katarakt (Unschärfe + Blendung)" } },
    "macular": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Makula (zentraler blinder Fleck)" } },
    "visualSnow": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Visual Snow (neurologisch)" } },
    "retinopathy": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Retinopathie (Trübungen + Flecken)" } },
    "tunnel": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Tunnelblick" } },
    "migraine": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Migräne-Aura" } },
    "toggleLightOn": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Lichteffekt aktivieren" } },
    "toggleLightOff": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Lichteffekt deaktivieren" } },
    "skip": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Zum Hauptinhalt springen" } },
    "language": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Sprache" } }
  },
  "home": {
    "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "BlindSite" } },
    "subtitle1": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Scrollen Sie zum Entdecken. Der Bildschirm ist fast schwarz – bewegen Sie die Maus, um versteckten Text zu finden." } },
    "subtitle2": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Linksklick erzeugt ein Echo. Rechtsklick blendet auf. Rechtsklick gedrückt halten = Blendung bleibt an." } },
    "donateTitle": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Unterstützung für Organisationen zu Blindheit & Behinderung (Deutschland)" } },
    "donateNote": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Diese Links dienen der Aufklärung und Unterstützung. Bitte prüfen Sie die Details der Organisationen vor einer Spende." } },
    "donateCta": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Spenden-Seite öffnen" } },
    "donations": {
      "dbsv": {
        "name": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "DBSV – Deutscher Blinden- und Sehbehindertenverband" } },
        "desc": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Bundesverband für blinde und sehbehinderte Menschen." } },
        "url": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "https://www.dbsv.org/" } }
      },
      "proretina": {
        "name": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "PRO RETINA Deutschland e. V." } },
        "desc": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Beratung und Infos zu Netzhauterkrankungen." } },
        "url": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "https://www.pro-retina.de/" } }
      },
      "aktionMensch": {
        "name": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Aktion Mensch" } },
        "desc": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Fördert Inklusionsprojekte für Menschen mit Behinderung." } },
        "url": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "https://www.aktion-mensch.de/" } }
      },
      "cbm": {
        "name": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "CBM Deutschland" } },
        "desc": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Internationale Organisation mit Fokus auf Behinderung und Augengesundheit." } },
        "url": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "https://www.cbm.de/" } }
      }
    },
    "sections": {
      "what": {
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Was ist Blindheit?" } },
        "text": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Blindheit bedeutet nicht immer völlige Dunkelheit. Viele blinde und sehbehinderte Menschen sehen Licht, Formen oder nur wenige Details." } }
      },
      "different": {
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Jeder Sehverlust ist anders" } },
        "text": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Es gibt nicht die eine “blinde Erfahrung”. Manche Erkrankungen betreffen das Zentrum, andere den Rand, den Kontrast oder das Farbsehen. Diese Seite ist ein Empathie‑Demo und kein medizinisches Werkzeug." } }
      },
      "navigate": {
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Wie orientieren sich blinde Menschen?" } },
        "text": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Viele nutzen einen Langstock oder Blindenführhund zusammen mit Gedächtnis, Geräuschen, Tastsinn und räumlicher Orientierung. Innen helfen Bodenstrukturen, Echos und Orientierungspunkte beim mentalen Kartenaufbau." } }
      },
      "tech": {
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Assistive Technologie" } },
        "text": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Screenreader (VoiceOver, NVDA, JAWS, TalkBack) lesen Oberflächen vor. Tastenkürzel und Gesten helfen, nach Überschriften, Links und Bedienelementen zu navigieren – ohne Maus." } }
      },
      "design": {
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Gute Barrierefreiheit hilft allen" } },
        "text": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Klare Überschriften, aussagekräftige Linktexte, Formularbeschriftungen und vollständige Tastaturbedienung bauen Barrieren ab. Probleme entstehen meist durch Designentscheidungen, nicht durch Blindheit." } }
      },
      "cataract": {
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Katarakt-Simulation (Unschärfe + Blendung)" } },
        "text": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Katarakt kann das Sehen trüben und starke Blendung verursachen. Probieren Sie das Mini‑Spiel und erhöhen Sie die Stärke." } },
        "cta": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Simulation öffnen" } }
      },
      "macular": {
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Makula‑Degeneration Simulation" } },
        "text": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Das Zentrum kann blockiert oder verschwommen sein, während die Peripherie bleibt. Testen Sie das Spiel und ändern Sie die Fleckgröße." } },
        "cta": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Simulation öffnen" } }
      },
      "color": {
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Farbsehen‑Spiel" } },
        "text": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Farbseh-Unterschiede machen manche Farbtöne schwer unterscheidbar. Finden Sie den abweichenden Kreis – und sehen Sie, warum “nur Farbe” als Hinweis nicht reicht." } },
        "cta": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Spiel öffnen" } }
      }
    }
  }
};
...
const normalizedLocales = [
  {
    ...
    files: [
      {
        path: "F:/BeBlind/BlindSite/i18n/locales/en.json",
        cache: void 0
      }
    ]
  },
  {
    ...
    files: [
      {
        path: "F:/BeBlind/BlindSite/i18n/locales/de.json",
        cache: void 0
      }
    ]
  }
...
function useLightCursor() {
  const x = useState("lightCursor:x", () => 0);
  const y = useState("lightCursor:y", () => 0);
  const lightEnabled = useState("lightCursor:enabled", () => true);
  const inputMode = useState("lightCursor:inputMode", () => "pointer");
  const viewport = useState("lightCursor:viewport", () => ({ width: 1, height: 1 }));
  useState("lightCursor:initialized", () => false);
  ...
  const pan = computed(() => {
    ...
    const rawPan = (normalizedX - 0.5) * 2;
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const HOME_ROUTE_NAMES = /* @__PURE__ */ new Set(["index"]);
...
_sfc_main$4.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/AudioLayer.vue");
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0;
};
const AudioLayer = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-00158ac5"]]);
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  __name: "AchievementsLayer",
  __ssrInlineRender: true,
  setup(__props) {
    ref({});
    const toasts = ref([]);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        "aria-live": "polite",
        "aria-atomic": "true"
      }, _attrs))} data-v-67fdb278><!--[-->`);
      ssrRenderList(toasts.value, (toast) => {
        _push(`<div class="toast" data-v-67fdb278><div class="toast__title" data-v-67fdb278>Achievement</div><div class="toast__body" data-v-67fdb278>${ssrInterpolate(toast.text)}</div></div>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/AchievementsLayer.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const AchievementsLayer = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-67fdb278"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: "app-root",
        style: unref(cssVars)
      }, _attrs))} data-v-6cd02a44>`);
      _push(ssrRenderComponent(_component_NuxtRouteAnnouncer, null, null, _parent));
      _push(`<a href="#main" class="skip-link" data-v-6cd02a44>${ssrInterpolate(unref(t)("nav.skip"))}</a>`);
      if (unref(lightEnabled)) {
        _push(`<div class="light-overlay" style="${ssrRenderStyle(unref(overlayStyle))}" aria-hidden="true" data-v-6cd02a44></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="cursor-effects" aria-hidden="true" data-v-6cd02a44><!--[-->`);
      ssrRenderList(echoes.value, (echo) => {
        _push(`<div class="cursor-echo" style="${ssrRenderStyle({ left: `${echo.x}px`, top: `${echo.y}px` })}" data-v-6cd02a44></div>`);
      });
      _push(`<!--]--><!--[-->`);
      ssrRenderList(flashes.value, (flash) => {
        _push(`<div class="screen-flash" style="${ssrRenderStyle({ "--flash-x": `${flash.x}px`, "--flash-y": `${flash.y}px` })}" data-v-6cd02a44></div>`);
      });
      _push(`<!--]-->`);
      if (flashHeld.value) {
        _push(`<div class="screen-flash screen-flash--held" style="${ssrRenderStyle({ "--flash-x": `${flashHeldX.value}px`, "--flash-y": `${flashHeldY.value}px` })}" data-v-6cd02a44></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><header class="top-bar" data-v-6cd02a44><div class="top-bar__title top-bar__title--blink" data-v-6cd02a44>BlindSite</div><nav class="top-bar__nav" aria-label="Main modes" data-v-6cd02a44>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(t)("nav.light"))}`);
          } else {
            return [
              createTextVNode(toDisplayString$1(unref(t)("nav.light")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: unref(localePath2)("/stick"),
        class: "top-bar__link"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(t)("nav.cane"))}`);
          } else {
            return [
              createTextVNode(toDisplayString$1(unref(t)("nav.cane")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: unref(localePath2)("/game"),
        class: "top-bar__link"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(t)("nav.blindTouch"))}`);
          } else {
            return [
              createTextVNode(toDisplayString$1(unref(t)("nav.blindTouch")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: unref(localePath2)("/colors"),
        class: "top-bar__link"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(t)("nav.colorVision"))}`);
          } else {
            return [
              createTextVNode(toDisplayString$1(unref(t)("nav.colorVision")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: unref(localePath2)("/cataract"),
        class: "top-bar__link"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(t)("nav.cataract"))}`);
          } else {
            return [
              createTextVNode(toDisplayString$1(unref(t)("nav.cataract")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: unref(localePath2)("/macular"),
        class: "top-bar__link"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(t)("nav.macular"))}`);
          } else {
            return [
              createTextVNode(toDisplayString$1(unref(t)("nav.macular")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: unref(localePath2)("/visual-snow"),
        class: "top-bar__link"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(t)("nav.visualSnow"))}`);
          } else {
            return [
              createTextVNode(toDisplayString$1(unref(t)("nav.visualSnow")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: unref(localePath2)("/retinopathy"),
        class: "top-bar__link"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(t)("nav.retinopathy"))}`);
          } else {
            return [
              createTextVNode(toDisplayString$1(unref(t)("nav.retinopathy")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: unref(localePath2)("/tunnel"),
        class: "top-bar__link"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(t)("nav.tunnel"))}`);
          } else {
            return [
              createTextVNode(toDisplayString$1(unref(t)("nav.tunnel")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: unref(localePath2)("/migraine"),
        class: "top-bar__link"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(t)("nav.migraine"))}`);
          } else {
            return [
              createTextVNode(toDisplayString$1(unref(t)("nav.migraine")), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</nav><div class="top-bar__right" data-v-6cd02a44><label class="lang"${ssrRenderAttr("aria-label", unref(t)("nav.language"))} data-v-6cd02a44><select class="lang__select"${ssrRenderAttr("value", unref(locale))} data-v-6cd02a44><option value="en" data-v-6cd02a44>EN</option><option value="de" data-v-6cd02a44>DE</option></select></label><button type="button" class="top-bar__toggle"${ssrRenderAttr("aria-pressed", unref(lightEnabled) ? "true" : "false")} data-v-6cd02a44>${ssrInterpolate(unref(lightEnabled) ? unref(t)("nav.toggleLightOff") : unref(t)("nav.toggleLightOn"))}</button></div></header>`);
      _push(ssrRenderComponent(AudioLayer, null, null, _parent));
      _push(ssrRenderComponent(AchievementsLayer, null, null, _parent));
      _push(`<main id="main" class="app-main" data-v-6cd02a44>`);
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-6cd02a44"]]);
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-U5leCLIc.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BFPMrkjJ.mjs'));
...
export { _export_sfc as _, __nuxt_component_0 as a, useLocalePath as b, useLightCursor as c, entry_default as default, tryUseNuxtApp as t, useI18n as u };
