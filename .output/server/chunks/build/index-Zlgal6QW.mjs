...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const styleFor = (index2) => {
      var _a;
      return {
        "--offset-x": `${(_a = offsets.value[index2]) != null ? _a : 0}px`
      };
    };
        ...
        if (s.route) {
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              var _a, _b;
              if (_push2) {
                _push2(`${ssrInterpolate((_a = s.cta) != null ? _a : "Open")}`);
              } else {
                return [
                  createTextVNode(toDisplayString((_b = s.cta) != null ? _b : "Open"), 1)
                ];
              }
            }),
            _: 2
...
//# sourceMappingURL=index-Zlgal6QW.mjs.map
