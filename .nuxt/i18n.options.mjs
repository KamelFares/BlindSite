...
// @ts-nocheck
import locale_en_46json_e2b9febd from "#nuxt-i18n/e2b9febd";
import locale_de_46json_b08b1d16 from "#nuxt-i18n/b08b1d16";
  ...
  en: [
    {
      ...
      load: () => Promise.resolve(locale_en_46json_e2b9febd),
      cache: true
    }
  ],
  de: [
    {
      ...
      load: () => Promise.resolve(locale_de_46json_b08b1d16),
      cache: true
    }
  ]
}
